...
std::string Card::GetCardValueName()const{ //Более элегантного способа совершить сие я не нашел ( разве что создать map<Value,std::string> и map<Suit,std::string>)	
	switch(value){
...
std::string Card::GetCardSuitName()const{	
	switch(suit){
